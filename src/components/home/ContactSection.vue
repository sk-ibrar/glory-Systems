  ...
  >
    <div class="container mx-auto mt-6">
      <div class="flex flex-col lg:flex-row gap-10">
        <div class="lg:w-1/3">
          ...
          <div class="space-y-8">
            <div class="flex items-start gap-6">
              <div class="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center text-blue-600">
        ...
        <div class="lg:w-2/3">
          <form
            class="bg-slate-50 p-8 md:p-12 rounded-[2rem] shadow-sm border border-gray-100"
            @submit.prevent
          >
            ...
            <Button
              label="Send Message"
              class="w-full py-5 font-bold text-lg shadow-xl"
            />
          </form>
        </div>
      </div>
